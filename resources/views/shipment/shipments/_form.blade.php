...
<h3><strong>Shipment Detail/货运:</strong></h3>
<hr />
<div class="form-group">
...
<h3><strong>Shipment Charge/运费:</strong></h3>
<hr />
...
<h3><strong>Finance/财务:</strong></h3>
<hr />
...
<div class="form-group">
    {!! Form::label('cc_date', '做销日期(CC Date):', ['class' => 'col-xs-4 col-sm-2 control-label']) !!}
    <div class='col-xs-8 col-sm-10'>
        {!! Form::text('cc_date', null, ['class' => 'form-control', $attr]) !!}
    </div>
</div>
...
<div class="form-group">
    {!! Form::label('issue_bank_address', '银行地址(Issue Bank Address):', ['class' => 'col-xs-4 col-sm-2 control-label']) !!}
    <div class='col-xs-8 col-sm-10'>
...
<div class="form-group">
    {!! Form::label('issue_bank_swift', '银行SWIST号(Issue Bank Swift):', ['class' => 'col-xs-4 col-sm-2 control-label']) !!}
    <div class='col-xs-8 col-sm-10'>
...
<div class="form-group">
    {!! Form::label('bill_of_draft_bank', '押汇银行(Bill of Draft Bank):', ['class' => 'col-xs-4 col-sm-2 control-label']) !!}
    <div class='col-xs-8 col-sm-10'>
