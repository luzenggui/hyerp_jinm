...
@section('main')
    ...
    {!! Form::model($order, ['method' => 'PATCH', 'action' => ['Department6\OrderController@update', $order->id], 'class'=>'panel-wrapper collapse in container-fluid', 'id' => 'formMain', 'files' => true]) !!}
        @include('department6.orders._form', ['submitButtonText' => '保存(Save)','attr' => '','btnclass' => 'btn btn-primary','attrdisable'=>'readonly' ])
    {!! Form::close() !!}
                    ...
                    <div class="row">\
                        ...
                        <div class="col-xs-3">\
                            <div class="form-group">\
                                ...
                                <div class="row">\
                                    <div class="col-xs-12">\
                                        <input class="form-control"  type="text" id="total_qty_' + String(item_num1) + '" name="total_qty" disabled="disabled">\
                                    </div>\
                                </div>\
                            </div>\
                        </div>\
                    ...
                    <div class="row">\
                        <div class="col-xs-3">\
                            <div class="form-group">\
                                ...
                                <div class="row">\
                                    <div class="col-xs-12">\
                                        <input class="form-control"  type="text" id="total_price_' + String(item_num1) + '" name="total_price" disabled="disabled">\
                                    </div>\
                                </div>\
                            </div>\
                        </div>\
                    ...
                    <div class="row">\
                        ...
                        <div class="col-xs-3">\
                            <div class="form-group">\
                                ...
                                <div class="row">\
                                    <div class="col-xs-10">\
                                        <input class="form-control"  type="text" id="total_price_' + String(item_num2) + '" name="total_price" disabled="disabled">\
                                    </div>\
                                    <div class="col-xs-1 text-right ">\
                                            <button type="button" class="btn btn-circle remove-item" aria-label="Close"><span aria-hidden="true">&times;</span></button>\
                                    </div>\
                    ...
                    <div class="row">\
                        ...
                        <div class="col-xs-3">\
                            <div class="form-group">\
                                ...
                                <div class="row">\
                                    <div class="col-xs-11">\
                                        <input class="form-control"  type="text" id="total_price_' + String(item_num3) + '" name="total_price" disabled="disabled">\
                                    </div>\
                                    <div class="col-xs-1 text-right ">\
                                        <button type="button" class="btn btn-circle remove-item" aria-label="Close"><span aria-hidden="true">&times;</span></button>\
                                    </div>\
