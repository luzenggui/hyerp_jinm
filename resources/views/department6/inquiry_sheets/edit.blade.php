...
@section('main')
    ...
    {!! Form::model($inquiry_sheet, ['method' => 'PATCH', 'action' => ['Department6\Inquiry_sheetsController@update', $inquiry_sheet->id], 'class'=>'panel-wrapper collapse in container-fluid', 'id' => 'formMain', 'files' => true]) !!}
        @include('department6.inquiry_sheets._form', ['submitButtonText' => '保存(Save)','attr' => '','btnclass' => 'btn btn-primary','attrdisable'=>'readonly' ])
    {!! Form::close() !!}
